            ...
            <div class="row">
                ...
                <div class="col-md-6" style="background-color: #f8f9fad8; padding: 20px;">
                    ...
                    <form action="" method="POST" id="add-to-cart-form">
                        ...
                        <!-- EU Size Selection (Table Layout for Admin View) -->
                        <div class="mt-3">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($availableSizes as $size => $stock)
                                        <tr>
                                            <td style="text-align: center; font-family: 'Fredoka', sans-serif; font-size: 14px; color: #333333;">
                                                {{ $size }}
                                            </td>
                                            <td style="text-align: center; font-family: 'Fredoka', sans-serif; font-size: 14px; color: #333333;">
                                                @if ($stock > 0)
                                                    <span class="stock-info" style="color: #28a745;">{{ $stock }} in stock</span>
                                                @else
                                                    <span class="stock-info out-of-stock" style="color: red;">Out of stock</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
