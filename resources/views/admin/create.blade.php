        ...
        <div class="row" style="margin-left: -10px; margin-right: -10px;">
            ...
            <div class="col-md-6" style="min-height: 600px; padding-right: 60px;">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" id="description" rows="6" class="form-control" style="min-height: 400px;" required>{{ old('description') }}</textarea>
                </div>
            </div>
                    ...
                    <div class="row">
                        @foreach(range(35, 46, 0.5) as $size)
                            <div class="col-3 mb-2">
                                ...
                                <input type="number" name="sizes[{{ $size }}]" id="size_{{ $size }}" class="form-control" min="0" placeholder="Quantity">
